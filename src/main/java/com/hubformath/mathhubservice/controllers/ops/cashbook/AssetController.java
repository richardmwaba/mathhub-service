...
import com.hubformath.mathhubservice.assemblers.ops.cashbook.AssetModelAssembler;
...
import com.hubformath.mathhubservice.services.ops.cashbook.IAssetService;
...
public class AssetController {
    ...
    public ResponseEntity<String> deleteAsset(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().body("Asset deleted succefully");
    }
}
