...
public class EquityTypeController {
    ...
    private final IEquityTypeService equityTypeService;

    @Autowired
    public EquityTypeController(final ModelMapper modelMapper, final IEquityTypeService equityTypeService) {
